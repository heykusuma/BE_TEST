              ...
              <div class="col-12 grid-margin">
                  <div class="card">
                      <div class="card-body">
                          ...
                          <form action="/data_activity/{{ $candidate->id }}" method="post" class="form-sample">
                            @method('patch')
                            @csrf
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="#" name="name" value="{{$candidate->name}}">
                                      </div>
                                      <div class="form-group">
                                          <label for="#">Jenis Kelamin</label><span class="text-danger">*</span>
                                          <input type="text" class="form-control" id="#" name="gender" value="{{$candidate->gender}}">
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="#" name="email" value="{{ $candidate->email }}">
                                      </div>
                                      <div class="form-group">
                                          <label for="#">Nomor HP</label><span class="text-danger">*</span>
                                          <input type="text" class="form-control" id="#" name="phone" value="{{ $candidate->phone }}">
                                      </div>
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="#" name="identity_number" value="{{ $candidate->identity_number }}">
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="#" name="bank_name" value="{{ $candidate->bank_name }}">
                                      </div>
                                      <div class="form-group">
                                          <label for="#">Nomor Bank Akun </label><span class="text-danger">*</span>
                                          <input type="text" class="form-control" id="#" name="bank_account" value="{{ $candidate->bank_account }}">
                                      </div>
                                      <div class="form-group">
                                          <label for="#">Alamat Domisili </label><span class="text-danger">*</span>
                                          <textarea class="form-control" id="#" rows="6" name="address">{{ $candidate->address }}</textarea>
                                      </div>
                                  </div>
                              </div><br>
