                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="#" value="{{$candidate->name}}" disabled>
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="#" value="{{$candidate->email}}" disabled>
                                      </div>
                                      <div class="form-group">
                                          <label for="#">Nomor HP</label><span class="text-danger">*</span>
                                          <input type="text" class="form-control" id="#" value="{{$candidate->phone}}" disabled>
                                      </div>
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="#" value="{{$candidate->identity_number}}" disabled>
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="#" value="{{$candidate->bank_name}}" disabled>
                                      </div>
                                      <div class="form-group">
                                          <label for="#">Nomor Bank Akun </label><span class="text-danger">*</span>
                                          <input type="text" class="form-control" id="#" value="{{$candidate->bank_account}}" disabled>
                                      </div>
                                      <div class="form-group">
                                          <label for="#">Alamat Domisili </label><span class="text-danger">*</span>
                                          <textarea class="form-control" id="#" rows="6"
                                            disabled>{{$candidate->address}}</textarea>
                                      </div>
                                  </div>
                              </div><br>
